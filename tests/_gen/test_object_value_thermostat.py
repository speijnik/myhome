...
import myhome._gen
from myhome._gen.models.object_value_thermostat import (  # noqa: E501
...
class TestObjectValueThermostat(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = myhome._gen.models.object_value_thermostat.ObjectValueThermostat()  # noqa: E501
        if include_optional:
            return ObjectValueThermostat(setpoint=1.337)
        else:
            return ObjectValueThermostat(
                setpoint=1.337,
            )
