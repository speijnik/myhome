...
from myhome._gen import rest
from myhome._gen.configuration import Configuration
from myhome._gen.exceptions import ApiException, ApiTypeError, ApiValueError
from myhome._gen.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint:
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.get_actual_user  # this is an instance of the class Endpoint
        api_instance.get_actual_user()  # this invokes api_instance.get_actual_user.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_actual_user.callable or self.callable in this class
