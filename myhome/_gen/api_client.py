...
from myhome._gen.exceptions import ApiException, ApiValueError
import myhome._gen.models
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(myhome._gen.models, klass)
    ...
    def __deserialize_datetime(self, string):
        ...
        try:
            ...
            raise rest.ApiException(
                status=0,
                reason=(
                    "Failed to parse `{}` as datetime object"
                    .format(string)
                )
            )
